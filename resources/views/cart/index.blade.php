...
@section('content')
    <div class="section pb-4">
        ...
        @else
            ...
            <div class="card border-0 shadow-sm rounded-4 sticky-bottom mb-3" style="bottom: 80px; z-index: 900;">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-6">
                            <a href="{{ route('checkout') }}"
                                class="btn btn-primary w-100 rounded-pill py-2 fw-bold">Rasmiylashtirish</a>
                        </div>
                    </div>
                </div>
            </div>
